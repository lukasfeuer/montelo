#' Look up p values for variable groups
#'
...
#'
#' @param varGroup string to identify variable group to be tested into model
#' @param vergl logical, should results be compared with other model variables?
#' @param model model object of interest
#' @param data data containing model variables and variables of varGroup
#'
#' @return plot of resulting p values
#' @export
#'
#'
p_check <- function(varGroup, vergl = FALSE, model, data) {
